...
(see \texttt{kernel/process\_scheduler.h}, \texttt{sched}),
and
(see \texttt{kernel/process\_scheduler.h}, \texttt{run}).
...
(see \texttt{kernel/cpu\_state.h}, \texttt{class cpu\_state}).
...
\texttt{process\_scheduler::run}
(see \texttt{kernel/process\_scheduler.cpp}, \texttt{run}).
...
(see \texttt{kernel/process\_scheduler.cpp}, \texttt{yield}),
(see \texttt{kernel/process.cpp}, \texttt{sleep}),
and
...
%%
\section{Code: CPU state and current process}
%%
...
The function
(see \texttt{kernel/cpu\_manager.h}, \texttt{cpu})
uses \lstinline{tp}
...
The function
(see \texttt{kernel/cpu\_manager.cpp}, \texttt{curproc})
