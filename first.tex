...
The kernel's major subsystems are gathered into a single top-level object of
type \lstinline{xv6pp} (see \texttt{kernel/xv6pp.h}), which holds instances of
the process, memory, device, and file-system managers.
