...
{\tt fetchstr} is an example (see \texttt{kernel/syscall.c}, \texttt{fetchstr}).
...
\item Is there a way to eliminate the special {\tt
  ...
  onto the kernel stack, or store them in the process
  object (see \texttt{kernel/process.h}, \texttt{process})?
